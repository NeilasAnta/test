...
async function solve(page) {
  try {
    await page.waitForFunction(() => {
      ...
      return !!iframe.contentWindow.document.querySelector('#rc-anchor-container > .rc-anchor-content > .rc-inline-block > .rc-anchor-center-container > .rc-anchor-center-item > #recaptcha-anchor')
    })

    let frames = await page.frames()
    const recaptchaFrame = frames.find(frame => frame.url().includes('api2/anchor'))
    
    const checkbox = await recaptchaFrame.$('#rc-anchor-container > .rc-anchor-content > .rc-inline-block > .rc-anchor-center-container > .rc-anchor-center-item > #recaptcha-anchor')
